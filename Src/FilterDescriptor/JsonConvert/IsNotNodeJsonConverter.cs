...
public class IsNotNodeJsonConverter : JsonConverter<NotNode>
{
    ...
    //{
    //    var queryOptions = QueryBuilder.DefaultOptions; //serializerOptions.GetQueryOptions();
    //    var targetType = TypeUtilits.GetTypeWinthName(typeName, queryOptions);
    //    return JsonValueTypeConverter.ConvertJsonElement(element, targetType, queryOptions);
    //}
