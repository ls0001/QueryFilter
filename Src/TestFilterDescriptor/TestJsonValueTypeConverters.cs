...
public class JsonValueTypeConverterTests
{
    ...
    public JsonValueTypeConverterTests(ITestOutputHelper output)
    {
        _Output =output;
    }
    ...
    public void ConvertJsonElement_Bool(string json, bool expected)
    {
        ...
        var result = JsonValueTypeConverter.ConvertJsonElement(element, typeof(bool), _convertOptions);
    ...
    {
        var element = JsonDocument.Parse($"{{\"value\": {json}}}").RootElement.GetProperty("value");
        var result = JsonValueTypeConverter.ConvertJsonElement(element, expected.GetType(), _convertOptions);
        Assert.Equal(expected, result);
    }
    ...
    public void ConvertJsonElement_DateTime(string json, string expected)
    {
     ...
     var sw=Stopwatch.StartNew();
        var result = JsonValueTypeConverter.ConvertJsonElement(element, typeof(DateTime), _convertOptions);
        sw.Stop();
    ...
    public void ConvertJsonElement_DateTimeOffset(string json, string expected)
    {
        var element = JsonDocument.Parse($"{{\"value\": {json}}}").RootElement.GetProperty("value");
        var sw= Stopwatch.StartNew();
        var result = JsonValueTypeConverter.ConvertJsonElement(element, typeof(DateTimeOffset), _convertOptions);
        sw.Stop();
    ...
    //{
    //    var element = JsonDocument.Parse($"{{\"value\": {json}}}").RootElement.GetProperty("value");
    //    var result = JsonValueTypeConverter.ConvertJsonElement(element, typeof(TimeSpan), _convertOptions);
    ...
    {
        var element = JsonDocument.Parse($"{{\"value\": {json}}}").RootElement.GetProperty("value");
        var result = JsonValueTypeConverter.ConvertJsonElement(element, typeof(Guid), _convertOptions);
    ...
    {
        var element = JsonDocument.Parse($"{{\"value\": {json}}}").RootElement.GetProperty("value");
        var result = JsonValueTypeConverter.ConvertJsonElement(element, typeof(TestEnum), _convertOptions);
        Assert.Equal(expected, result);
    }
    ...
    {
        var element = JsonDocument.Parse($"{{\"value\": {json}}}").RootElement.GetProperty("value");
        var result = JsonValueTypeConverter.ConvertJsonElement(element, typeof(string), _convertOptions);
        Assert.Equal(expected, result);
    }
}
