...
namespace Sag.Data.Common
{
    ...
    public class CRC
    {
        ...
        public static string CalculateCRC(byte[] buf) => CalculateCRC(buf, buf.Length).ToString();

        // Return the CRC of the bytes buf[0..len-1].
        public static ulong  CalculateCRC(byte[] buf, int len) =>
            (update_crc(0xffffffffL, buf, len) ^ 0xffffffffL);
    }
