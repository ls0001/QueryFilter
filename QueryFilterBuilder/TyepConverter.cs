...
namespace Sag.Data.Common
{
    ...
    public static class TypeExt
    {
        ...
        new Dictionary<TypeCode, HashSet<TypeCode>>() {
            ...
            { TypeCode.Int32, new HashSet<TypeCode>(){ TypeCode.Char, TypeCode.SByte, TypeCode.Byte,TypeCode.Int16, TypeCode.UInt16 } },
            { TypeCode.UInt32, new HashSet<TypeCode>(){ TypeCode.Char, TypeCode.Byte, TypeCode.UInt16 } },
            { TypeCode.Int64, new HashSet<TypeCode>(){ TypeCode.Char, TypeCode.SByte, TypeCode.Byte,TypeCode.Int16, TypeCode.UInt16, TypeCode.Int32, TypeCode.UInt32 } },
            { TypeCode.UInt64, new HashSet<TypeCode>(){ TypeCode.Char, TypeCode.Byte, TypeCode.UInt16, TypeCode.UInt32 } },
            { TypeCode.Single, new HashSet<TypeCode>(){ TypeCode.Char, TypeCode.SByte, TypeCode.Byte,TypeCode.Int16, TypeCode.UInt16, TypeCode.Int32, TypeCode.UInt32, TypeCode.Int64, TypeCode.UInt64 } },
            { TypeCode.Double, new HashSet<TypeCode>(){ TypeCode.Char, TypeCode.SByte, TypeCode.Byte, TypeCode.Int16,TypeCode.UInt16, TypeCode.Int32, TypeCode.UInt32, TypeCode.Int64, TypeCode.UInt64, TypeCode.Single } },
            { TypeCode.Decimal, new HashSet<TypeCode>(){ TypeCode.Char, TypeCode.SByte, TypeCode.Byte,TypeCode.Int16, TypeCode.UInt16, TypeCode.Int32, TypeCode.UInt32, TypeCode.Int64, TypeCode.UInt64 } },
